#!/bin/bash
cat > build_full_dissertation.py << 'PYEOF'
...
# Load the REAL template from your actual path
...
# Save to the current working directory safely
doc.save('Completed_Dissertation.docx')
print("Done! Check your current folder for 'Completed_Dissertation.docx'.")
PYEOF

python3 build_full_dissertation.py
